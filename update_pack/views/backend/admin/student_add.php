<div class="row">
    ...
    <div class="col-md-4">
		<blockquote class="blockquote-blue">
			<p>
				<strong>Instruksi Penerimaan Santri</strong>
			</p>
			<p>
			Penerimaan siswa baru akan secara otomatis membuat pendaftaran ke kelas yang dipilih pada sesi lari. Silakan periksa dan periksa kembali informasi yang telah Anda masukkan karena setelah Anda menerima siswa baru, Anda tidak akan dapat mengedit kelasnya,roll,bagian tanpa mempromosikan ke sesi berikutnya.
			</p>
		</blockquote>
	</div>
