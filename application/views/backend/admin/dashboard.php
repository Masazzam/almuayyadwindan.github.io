		...
		<div class="row">
            <div class="col-md-12">
                ...
                <div class="tile-stats tile-red">
                    ...
                    <h3><?php echo get_phrase('Santri');?></h3>
                   <p>Jumlah Santri</p>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="tile-stats tile-aqua">
                    ...
                    <h3><?php echo get_phrase('Wali Santri');?></h3>
                   <p>Jumlah Wali Santri</p>
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="tile-stats tile-blue">
                    ...
                    <h3><?php echo get_phrase('Kehadiran');?></h3>
                   <p>Total Kehadiran Santri Hari ini</p>
                </div>
