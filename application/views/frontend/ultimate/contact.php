...
<main id="content" role="main">
  ...
  <div class="clearfix space-1">
    ...
    <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-5">
      <span class="btn btn-xs btn-soft-success btn-pill mb-2">Kontak info</span>
    </div>
    <!-- End Title -->
    <div class="row no-gutters">
      ...
      <div class="col-sm-6 col-lg-3 u-ver-divider u-ver-divider--none-lg">
        ...
        <div class="text-center py-5">
          ...
          <h2 class="h6 mb-0"><?php echo get_phrase('Windan makamhaji, Dusun IV,<br> Makamhaji, Kec. Kartasura,<br> Kabupaten Sukoharjo,<br> Jawa Tengah 57161'); ?></h2>
          <p class="mb-0">
      ...
      <div class="col-sm-6 col-lg-3 u-ver-divider u-ver-divider--none-lg">
        ...
        <div class="text-center py-5">
          ...
          <h3 class="h6 mb-0"><?php echo get_phrase('<br>amwiners@gmail.com'); ?></h3>
          <p class="mb-0">
      ...
      <div class="col-sm-6 col-lg-3 u-ver-divider u-ver-divider--none-lg">
        ...
        <div class="text-center py-5">
          ...
          <h3 class="h6 mb-0"><?php echo get_phrase('<br>(0271) 726288'); ?></h3>
          <p class="mb-0">
  ...
  <div class="container space-2 space-md-3">
    ...
    <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-9">
      <span class="btn btn-xs btn-soft-success btn-pill mb-2">Form Kontak</span>
