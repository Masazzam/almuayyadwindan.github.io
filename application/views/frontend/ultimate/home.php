  ...
  <main id="content" role="main">
        ...
        <div class="row justify-content-between align-items-center">
          <div class="col-lg-7 mb-7 mb-lg-0">
            <div class="pr-md-4">
              <!-- Title -->
              <div class="mb-7">
                <span class="btn btn-xs btn-soft-success btn-pill mb-2">Tentang Kami</span>
              ...
              <a class="btn btn-sm btn-primary btn-wide transition-3d-hover" 
                ...
                Selanjutnya <span class="fas fa-angle-right ml-2"></span></a>
            </div>
          </div>
    ...
    <div class="container space-2 space-md-3">
      ...
      <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-9">
        <span class="btn btn-xs btn-soft-success btn-pill mb-2">Guru</span>
        <h2 class="text-primary">Guru Professional Kami</span></h2>
      </div>
      <!-- End Title -->
    ...
    <div class="bg-light">
      <div class="container space-2 space-md-3">
        ...
        <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-9">
          ...
          <h2 class="text-primary">Event Mendatang</h2>
        </div>
        <!-- End Title -->
