    ...
    <div class="container text-center space-top-4 space-top-md-4 space-top-lg-3 space-bottom-1">
      ...
      <div class="w-md-80 w-lg-50 mx-auto mb-5">
        <h1 class="h1 text-white">
          <span class="font-weight-semi-bold">Pengumuman</span>
        </h1>
      </div>
      <!-- End Title -->
    </div>
  ...
  <div class="bg-light">
    <div class="container space-2 space-md-2">
      ...
      <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-9">
        <span class="btn btn-xs btn-soft-success btn-pill mb-2">Pemberitahuan</span>
        <h2 class="text-primary">Follow up Pemberitahuan Pesantren</h2>
      </div>
      <!-- End Title -->
